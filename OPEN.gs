...
function onOpen() {
  ...
  SpreadsheetApp.getUi()
    ...
    .addSeparator()
    .addSubMenu(SpreadsheetApp.getUi().createMenu('📨 Plain Emails (name only)')
      .addItem('📝 Create Plain Drafts (name only)', 'createPlainDraftsFromList')
      .addItem('📤 Send Plain Emails (name only)', 'sendPlainEmailsFromList'))
    .addSeparator()
